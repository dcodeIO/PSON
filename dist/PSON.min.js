...
this.next++;this.progressive=!!d};a.prototype.encode=function(b,d){var c=!1;d||(d=new f,c=!0);var a=d.littleEndian;try{return this._encodeValue(b,d.LE()),d.littleEndian=a,c?d.flip():d}catch(e){throw d.littleEndian=a,e;}};a.prototype._encodeValue=function(b,d,a){if(null===b)d.writeUint8(c.NULL);else switch(typeof b){case "function":b=b.toString();case "string":0==b.length?d.writeUint8(c.ESTRING):this.dict.hasOwnProperty(b)?(d.writeUint8(c.STRING_GET),d.writeVarint32(this.dict[b])):(d.writeUint8(c.STRING),
d.writeVString(b));break;case "number":a=parseInt(b);b===a?(a=f.zigZagEncode32(b),a<=c.MAX?d.writeUint8(a):(d.writeUint8(c.INTEGER),d.writeVarint32ZigZag(b))):(e.writeFloat32(b,0),b===e.readFloat32(0)?(d.writeUint8(c.FLOAT),d.writeFloat32(b)):(d.writeUint8(c.DOUBLE),d.writeFloat64(b)));break;case "boolean":d.writeUint8(b?c.TRUE:c.FALSE);break;case "object":var h;if(Array.isArray(b))if(0==b.length)d.writeUint8(c.EARRAY);else for(d.writeUint8(c.ARRAY),d.writeVarint32(b.length),h=0;h<b.length;h++)this._encodeValue(b[h],
d);else if(g&&b instanceof g)d.writeUint8(c.LONG),d.writeVarint64ZigZag(b);else try{b=f.wrap(b),d.writeUint8(c.BINARY),d.writeVarint32(b.remaining()),d.append(b)}catch(k){var m=Object.keys(b),l=0;for(h=0;h<m.length;h++)"undefined"!==typeof b[m[h]]&&l++;if(0===l)d.writeUint8(c.EOBJECT);else for(d.writeUint8(c.OBJECT),d.writeVarint32(l),a||(a=!!b._PSON_EXCL_),h=0;h<m.length;h++)l=m[h],"undefined"!==typeof b[l]&&(this.dict.hasOwnProperty(l)?(d.writeUint8(c.STRING_GET),d.writeVarint32(this.dict[l])):
(this.progressive&&!a?(this.dict[l]=this.next++,d.writeUint8(c.STRING_ADD)):d.writeUint8(c.STRING),d.writeVString(l)),this._encodeValue(b[l],d))}break;case "undefined":d.writeUint8(c.NULL)}};return a}(k,e.T);e.Decoder=function(f,c){var e=f.Long,g=function(a,b){this.dict=a&&Array.isArray(a)?a:[];this.progressive=!!b};g.prototype.decode=function(a){a instanceof f||(a=f.wrap(a));var b=a.littleEndian;try{var d=this._decodeValue(a.LE());a.littleEndian=b;return d}catch(c){throw a.littleEndian=b,c;}};g.prototype._decodeValue=
function(a){var b=a.readUint8();if(b<=c.MAX)return f.zigZagDecode32(b);switch(b){case c.NULL:return null;case c.TRUE:return!0;case c.FALSE:return!1;case c.EOBJECT:return{};case c.EARRAY:return[];case c.ESTRING:return"";case c.OBJECT:for(var b=a.readVarint32(),d={};0<=--b;)d[this._decodeValue(a)]=this._decodeValue(a);return d;case c.ARRAY:b=a.readVarint32();for(d=[];0<=--b;)d.push(this._decodeValue(a));return d;case c.INTEGER:return a.readVarint32ZigZag();case c.LONG:return e?a.readVarint64ZigZag():
